...
public class WorkspaceEvent {
	...
	public final static int BLOCK_ADDED_TOCAMPUS = 20;

	public final static int BLOCK_REMOVED = 4;
	public final static int BLOCKS_CONNECTED = 5;
	
	public final static int BLOCKS_CONNECT_MISSED = 21;
	...
	/**
	 * Constructs a new WorkspaceEvent. This constructor should be used to
	 * report page added, removed events. The WorkspaceWidget page parameter
	 * should be an instance of Page.
	 * 
	 * @param page
	 * @param eventType
	 */
	...
	/**
	 * Constructs a new WorkspaceEvent. This constructor should be used to
	 * report page renamed events. The WorkspaceWidget page parameter should be
	 * an instance of Page.
	 * 
	 * @param page
	 * @param oldName
	 *            the old String name of this page
	 * @param eventType
	 */
	...
	/**
	 * Constructs a new WorkspaceEvent. This constructor should be used to
	 * report the following: block added, removed, renamed, compiled, moved.
	 * 
	 * @param widget
	 * @param blockID
	 * @param eventType
	...
	/**
	 * Constructs a new WorkspaceEvent. This constructor should be used to
	 * report block connected/disconnected events. The specified link contains
	...
	public WorkspaceEvent(WorkspaceWidget widget, BlockLink link,
			int eventType, boolean userSpawned) {
		this.widget = widget;
		this.link = link;
		this.eventType = eventType;
		this.userSpawned = userSpawned;
	...
	/**
	 * Returns the Long ID of the Block where this event occured. For block
	 * connection events, this id is Block.NULL since the event occurred from
	 * two blocks.
	 */
	...
	/**
	 * Returns the BlockLink where this event originated, or null if the event
	 * type of this is not block connected or disconnected.
	 * 
	 * @return the BlockLink where this event originated, or null if the event
	 *         type of this is not block connected or disconnected.
	 */
	...
	/**
	 * Returns the original name of the source widget; null if the source
	 * widget's name did not change.
	 * 
	 * @return the original name of the source widget; null if the source
	 *         widget's name did not change.
	 */
	...
	public String toString() {
		...
		case BLOCK_STACK_COMPILED:
			return "WorkspaceEvent(BLOCK_STACK_COMPILED: "
		...
		case BLOCK_GENUS_CHANGED:
			return "WorkspaceEvent(BLOCK_GENUS_CHANGED: "
					+ Block.getBlock(blockID) + ")";
